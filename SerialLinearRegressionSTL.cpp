...
void SerialLinearRegressionSTL::calculate_Function(std::vector<Point> &points) {
    /**
...
std::vector<Point> SerialLinearRegressionSTL::calculate_points(std::vector<double> &x) {
    /**
